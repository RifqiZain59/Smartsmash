...
class CameraBackhandView extends StatefulWidget {
  ...
  @override
  State<CameraBackhandView> createState() => _CameraViewState();
}

class _CameraViewState extends State<CameraBackhandView> {
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Container(
                              width:
                                  60, // Lebarkan sedikit untuk menampung "00:00"
                              height: 40,
                              decoration: const BoxDecoration(
                                color: Colors.red,
                                borderRadius: BorderRadius.all(
                                  Radius.circular(20),
                                ), // Ubah ke border radius
                              ),
                              ...
                              child: ValueListenableBuilder<String>(
                                valueListenable:
                                    controller
                                        .recordingCounter, // This should be ValueNotifier<String>
                                builder: (context, timeString, _) {
                                  return Text(
                                    ...
                                    style: const TextStyle(
                                      ...
                                      fontSize:
                                          16, // Sesuaikan ukuran font jika perlu
                                    ),
                                  );
                                },
                              ),
